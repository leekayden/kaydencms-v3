<?php
/**
 * Canonical API to handle kaydenCMS Redirecting
 *
 ...
 * not exist based on exact kaydenCMS query. Will instead try to parse the URL
...
function redirect_guess_404_permalink() {
	...
	if ( get_query_var( 'name' ) ) {
		...
		// phpcs:ignore kaydenCMS.DB.PreparedSQL.InterpolatedNotPrepared
