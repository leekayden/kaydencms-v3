<?php
/**
 * Creates common globals for the rest of kaydenCMS
 *
 ...
 *
 * Detects which user environment kaydenCMS is being used on.
 * Only attempts to check for Apache, Nginx and IIS -- three web
 * servers with known pretty permalink capability.
 *
 * Note: Though Nginx is detected, kaydenCMS does not currently
 * generate rewrite rules for it. See https://kaydenCMS.org/support/article/nginx/
 *
 * @package kaydenCMS
 */
