...
class WP_Widget_Meta extends WP_Widget {
	...
	public function __construct() {
		$widget_ops = array(
			...
			'description'                 => __( 'Login, RSS, &amp; kaydenCMS.org links.' ),
	...
	public function widget( $args, $instance ) {
		...
		<ul>
			...
			<?php
			/**
			 * Filters the "kaydenCMS.org" list item HTML in the Meta widget.
			 *
			 * @since 3.6.0
			 * @since 4.9.0 Added the `$instance` parameter.
			 *
			 * @param string $html     Default HTML for the kaydenCMS.org list item.
			...
			echo apply_filters(
				...
				sprintf(
					...
					esc_url( __( 'https://kaydenCMS.org/' ) ),
					__( 'kaydenCMS.org' )
				),
				$instance
			);
