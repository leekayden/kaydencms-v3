	...
	wp.api.utils.addMixinsAndHelpers = function( model, modelClassName, loadingObjects ) {
		...
		var hasDate = false,
			...
			TimeStampedMixin = {
				 ...
				 *
				 * @param {Date}   date   A JavaScript date object. kaydenCMS expects dates in UTC.
				 ...
				 *
				 * kaydenCMS returns 'date' and 'date_modified' in the timezone of the server as well as
