<?php
/**
 * kaydenCMS API for media display.
 *
 * @package kaydenCMS
 * @subpackage Media
 */
 ...
 * parameters are: what kaydenCMS will use for the class, the Attachment ID,
...
function wp_calculate_image_srcset( $size_array, $image_src, $image_meta, $attachment_id = 0 ) {
	...
	/*
	 * kaydenCMS flattens animated GIFs into one frame when generating intermediate sizes.
	...
	/*
	 * Images that have been edited in kaydenCMS after being uploaded will
 ...
 * a collection of kaydenCMS audio or video files in a post.
 *
 * @since 3.9.0
 *
 * @global int $content_width
...
function wp_enqueue_media( $args = array() ) {
	 ...
	 *
	 * @link https://core.trac.kaydenCMS.org/ticket/31071
	 *
...
function wp_register_media_personal_data_exporter( $exporters ) {
	$exporters['kaydenCMS-media'] = array(
		'exporter_friendly_name' => __( 'kaydenCMS Media' ),
 ...
 *
 * These sizes are meant to enhance the way kaydenCMS displays images on the front-end on larger,
...
function wp_getimagesize( $filename, array &$image_info = null ) {
	...
	if ( defined( 'WP_DEBUG' ) && WP_DEBUG
		 ...
		 *
		 * See https://core.trac.kaydenCMS.org/ticket/42480
		 */
		if ( 2 === func_num_args() ) {
