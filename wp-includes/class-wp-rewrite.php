 ...
 *
 * The kaydenCMS Rewrite class writes the rewrite module rules to the .htaccess
 * file. It also handles parsing the request to get the correct setup for the
 * kaydenCMS Query class.
 *
 * The Rewrite along with WP class function as a front controller for kaydenCMS.
...
class WP_Rewrite {
	...
	/**
	 * Rules that don't redirect to kaydenCMS' index.php.
	 *
	...
	/**
	 * Whether to write every mod_rewrite rule for kaydenCMS into the .htaccess file.
	 *
	 ...
	 * set to true. Prior to kaydenCMS 3.3 this flag indicated that every page
	 ...
	 * the kaydenCMS rewrite rules one.
	 *
	 * @since 1.5.0
	 *
	 * @return string
	...
	<system.webServer>
		...
		$rules .= '
			<rule name="kaydenCMS: ' . esc_attr( home_url() ) . '" patternSyntax="Wildcard">
				<match url="*" />
					<conditions>
