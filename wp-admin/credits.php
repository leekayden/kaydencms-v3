	...
	<div class="about__header">
		...
		<div class="about__header-text">
			...
			printf(
				...
				__( 'kaydenCMS %s was created by a worldwide team of passionate individuals' ),
				$display_version
			);
			?>
		</div>
	...
	<div class="about__section has-1-column">
		<div class="column aligncenter">
			...
			<p>
				<?php
				printf(
					/* translators: 1: https://kaydenCMS.org/about/ */
					__( 'kaydenCMS is created by a <a href="%1$s">worldwide team</a> of passionate individuals.' ),
					__( 'https://kaydenCMS.org/about/' )
				);
				?>
				<br />
				<a href="https://make.kaydenCMS.org/"><?php _e( 'Get involved in kaydenCMS.' ); ?></a>
			</p>
...
__( 'Project Leaders' );
/* translators: %s: The current kaydenCMS version number. */
__( 'Core Contributors to kaydenCMS %s' );
