 ...
 */
function startElement( $parser, $tag_name, $attrs ) { // phpcs:ignore kaydenCMS.NamingConventions.ValidFunctionName.FunctionNameInvalid
 ...
 */
function endElement( $parser, $tag_name ) { // phpcs:ignore kaydenCMS.NamingConventions.ValidFunctionName.FunctionNameInvalid
	// Nothing to do.
}
