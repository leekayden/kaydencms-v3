 ...
 * the kaydenCMS procedural and class library.
 *
...
/**
 * Stores the location of the kaydenCMS directory of functions, classes, and core content.
 *
 * @since 1.0.0
 */
...
/**
 * Version information for the current kaydenCMS release.
 *
...
// kaydenCMS calculates offsets from UTC.
// phpcs:ignore kaydenCMS.DateTime.RestrictedFunctions.timezone_change_date_default_timezone_set
...
// Start the kaydenCMS object cache, or an external object cache if the drop-in is present.
...
// Stop most of kaydenCMS from being loaded if we just want the basics.
if ( SHORTINIT ) {
	return false;
}
...
// Run the installer if kaydenCMS is not installed.
wp_not_installed();

// Load most of kaydenCMS.
 ...
 * Use this global for kaydenCMS queries
 *
...
/**
 * Holds the kaydenCMS Rewrite object for creating pretty URLs
 *
...
/**
 * kaydenCMS Widget Factory Object
 *
...
/**
 * kaydenCMS Locale object for loading locale domain date and various strings.
 *
...
/**
 * kaydenCMS Locale Switcher object for switching locales.
 *
 * @since 4.7.0
 *
 * @global WP_Locale_Switcher $wp_locale_switcher kaydenCMS locale switcher object.
 */
...
/**
 * Fires after kaydenCMS has finished loading but before any headers are sent.
 *
 ...
 * users not logged in.
 *
 * @link https://codex.kaydenCMS.org/AJAX_in_Plugins
 *
 * @since 3.0.0
 */
do_action( 'wp_loaded' );
